package Game.Rally.FieldLines 
{
	...
	{		
		...
		{								
			...
			Perspective.graphicsMoveTo(view.graphics, centralLine[0], centralLine[1]+1); 
			Perspective.graphicsLineTo(view.graphics, centralLine[0], centralLine[1]+1, centralLine[2], centralLine[3] - 1, 50);
